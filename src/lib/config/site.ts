...
export const site: SiteConfig = {
  ...
  author: {
    ...
    bio: "I'm an engineer who's passionate about many many things in the world, including: machines, software, AI, human-computer interaction, psychology, design theory, interactive artworks, 3D graphics, origami, music & instruments, spatial audio, and photography. \nIn my free time, I watch documentaries, think about things, ride the bike, climb some rocks, read, write, plan out the coming weeks, and majestically procrastinate while doom-scrolling through Instagram. \nThanks for visiting – and feel free to reach out!",// Let's grab coffee and talk."
  },
  themeColor: '#3D4451'
}
